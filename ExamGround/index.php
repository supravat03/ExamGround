    ...
    <nav class="navbar navbar-default navbar-fixed-top" role="navigation" style="background:#66CCFF">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php" style="color:#FFFFFF">ExamGRound</a>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li style="color:#FFFFFF">
                        <a style="color:#FFFFFF" href=""><i class="fa fa-home fa-fw"></i>About</a>
                    </li>
        ...
        <header id="myCarousel" class="carousel slide">
            ...
            <div class="carousel-inner">
                <div class="item active">
                    ...
                    <div class="fill" style="background-image:url('images/edu1.jpg');"></div>
                ...
                <div class="item">
                    <div class="fill" style="background-image:url('images/edu3.jpg');"></div>
                    <div class="carousel-caption">
                ...
                <div class="item">
                    <div class="fill" style="background-image:url('images/edu2.jpg');"></div>
                    <div class="carousel-caption">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="col-sm-10" style="margin-top:60px;margin-bottom:80px;margin-left:60px">
                        <h1 class="welcome" style="color: #66CCFF; text-align :center">Welcome To EXamGround</h1>
            ...
            <div class="navbar-fixed-bottom nav navbar-inverse text-center" style="padding:15px;height:40px; background:#66CCFF">
                <span style="color:#FFFFFF">Developed By ....... <a href="" style="color: red;">Mr. Robot</a> </span>
            </div>
            <!-- jQuery -->
