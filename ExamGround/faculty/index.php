        ...
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            ...
            <li><a href="index.php?page=update_profile"><span class="glyphicon glyphicon-asterisk"></span> Update Profile</a></li>
			 <li><a href="index.php?page=feedback"><span class="glyphicon glyphicon-comment"></span> Feedback</a></li>
       <li><a href="quiz"><span class="glyphicon glyphicon-pencil"></span> Set Quiz</a></li>
          </ul>
