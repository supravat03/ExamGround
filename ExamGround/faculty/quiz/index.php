...
<nav class="navbar navbar-inverse navbar-fixed-top" style="background:#428bca">
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" style="color:#FFFFFF" href="#">Hello <?php echo $row['name'];?></a>
        </div>
      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
			...
			<li><a href="index.php?quiz_part=view_paper"><span class="glyphicon glyphicon-user"></span> View Paper </a></li>
            <li><a href="index.php?quiz_part=add_question"><span class="glyphicon glyphicon-asterisk"></span>Add Question</a></li>
			 <li><a href="index.php?quiz_part=add_quiz"><span class="glyphicon glyphicon-pencil"></span> Add Quiz</a></li>
